...
const Privacy: React.FC = () => {
  ...
  return (
    <>
      <WindowTitle title={`Privacy Policy`} />
      <div className="section">
        <div className="container">
          ...
          <div className="rich-text-2 w-richtext">
            <p>
              At Copydeck, accessible at copydeck.ai, one of our main priorities
            ...
            <p>
              ...
              information, including items such as name, Copydeck, address,
            ...
            <p>
              ...
              the advertising partners of Website Name.
            </p>
            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Website Name,
